...
export ZSH="/Users/jorgeborges/.oh-my-zsh"
...
plugins=(git docker docker-compose kubectl zsh-completions zsh-z zsh-autosuggestions zsh-syntax-highlighting) # zsh-syntax-highlighting MUST be the last plugin
